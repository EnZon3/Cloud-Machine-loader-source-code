function createUnityInstance(e, t, r) {
    ...
    function i(e, t, r) {
        f.symbols ? a(s(e, f.symbols), t, r) : f.symbolsUrl ? u("symbolsUrl").then(function(n) {
            for (var o = "", i = 0; i < n.length; i++) o += String.fromCharCode(n[i]);
            f.symbols = JSON.parse(o), a(s(e, f.symbols), t, r)
        }).catch(function(n) {
            a(e, t, r)
        }) : a(e, t, r)
    }
    ...
    function u(e) {
        return new Promise(function(t, r) {
            ...
            n.open("GET", f[e]), n.responseType = "arraybuffer", n.addEventListener("progress", function(t) {
                d(e, t)
            }), n.addEventListener("load", function(r) {
                d(e, r), t(new Uint8Array(n.response))
            }), n.send()
        })
    }
    ...
    function l() {
        return new Promise(function(e, t) {
            ...
            r.src = f.frameworkUrl, r.onload = function() {
                var t = unityFramework;
                unityFramework = null, r.onload = null, e(t)
            }, document.body.appendChild(r), f.deinitializers.push(function() {
    ...
    var m = {
        ...
        Quit: function() {
            return new Promise(function(t, r) {
                f.shouldQuit = !0, f.onQuit = t, h.forEach(function(t) {
    ...
    return f.SystemInfo = function() {
        ...
        return i(e, "", 0), !0
    }, Error.stackTraceLimit = Math.max(Error.stackTraceLimit || 0, 50), f.XMLHttpRequest = function() {
        function e(e) {
        ...
        f.SystemInfo.hasWebGL ? f.SystemInfo.hasWasm ? (1 == f.SystemInfo.hasWebGL && f.print('Warning: Your browser does not support "WebGL 2.0" Graphics API, switching to "WebGL 1.0"'), f.startupErrorHandler = t, r(0), f.postRun.push(function() {
